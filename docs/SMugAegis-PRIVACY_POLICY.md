...
SMugAegis is a native macOS application that helps you download your photos from SmugMug directly to your Mac. This privacy policy explains how SMugAegis handles your data and protects your privacy in compliance with Apple's App Store guidelines and applicable privacy laws.
...
- ❌ **Passwords**: Your SmugMug password is never stored, transmitted, or accessible to SMugAegis
...
- No information is transmitted to SMugAegis servers (we don't operate any servers)
...
- Only SMugAegis and your user account can access the stored authentication data
...
- **Application Settings**: `~/Library/Application Support/SMugAegis/` (local preferences)
- **Download Records**: Local application data folder (temporary tracking data)
- **Application Logs**: `~/Library/Logs/SMugAegis/` (technical logs, automatically cleaned)

### Data Retention and Cleanup
- **Authentication Tokens**: Stored until you logout, revoke access, or uninstall the app
- **Application Settings**: Retained until you uninstall SMugAegis or manually reset preferences
...
### Security Measures
- **App Sandbox**: SMugAegis runs in Apple's App Sandbox for enhanced security isolation
...
- SMugAegis connects exclusively to SmugMug's official API endpoints
...
You can revoke SMugAegis's access to your SmugMug account through multiple methods:

1. **Within SMugAegis**: Use the "Logout" or "Disconnect Account" feature to remove local authentication
2. **SmugMug Account Settings**: 
   - Log into SmugMug.com
   - Go to Account Settings → Privacy → Authorized Applications
   - Find "SMugAegis" and click "Revoke Access"
3. **Complete Data Removal**:
   - Uninstall SMugAegis from Applications folder
   - Manually delete `~/Library/Application Support/SMugAegis/` for complete cleanup
   - Keychain data is automatically removed when the app is uninstalled

## Children's Privacy (COPPA Compliance)

SMugAegis is not specifically directed at children under 13 years of age. We do not knowingly collect, use, or disclose personal information from children under 13. If you are under 13 years of age, please do not use SMugAegis without parental supervision and consent.
...
- Changes in SMugAegis's functionality or features
...
- Continued use of SMugAegis after policy updates constitutes acceptance of the changes

## Data Processing Transparency

### Automated Decision Making
SMugAegis does not use automated decision-making or profiling that would significantly affect users. All processing is straightforward data transfer and storage as explicitly requested by the user.
...
If you have questions, concerns, or requests regarding this privacy policy or SMugAegis's data handling practices:
...
- **Documentation**: https://github.com/harikas14/Pages/blob/main/docs/SMugAegis-UserGuide.md
- **FAQ**: https://github.com/harikas14/Pages/blob/main/docs/SMugAegis-faq.md
...
SMugAegis complies with Apple's App Store Review Guidelines including:
...
**SMugAegis is designed with privacy as a fundamental principle**:
